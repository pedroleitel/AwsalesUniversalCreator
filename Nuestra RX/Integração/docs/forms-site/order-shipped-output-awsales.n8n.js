// n8n Code node: normaliza order_shipped -> Custom Action (BRANCH OUTPUT).
// Mode: Run Once for Each Item.
//
// Este e o ramo OUTPUT: fecha (converte) o ONBOARDING 1 (aprovacao).
//   Switch [order_shipped] -> ESTE Code (JavaScript5) -> HTTP "Order shipping (output)"
//   -> credencial de conversao ligada como Evento de Conversao do Onboarding 1.
//
// O ramo INPUT (abre o Onboarding 2) e o OUTRO arquivo: order-shipped-input-awsales.n8n.js,
// que sai com um SOURCE DIFERENTE para a AWSales distinguir output de input.
//
...
const SOURCE = {
  id: 'nuestra_rx_order_shipped_output',
  name: 'Nuestra RX - Pedido despachado (order_shipped) [output - cierra Onboarding 1]',
};
