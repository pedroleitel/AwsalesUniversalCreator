...
Mensagens de Abertura Enviadas (para o bot saber de onde começa):
O lead já recebeu mensagens de lembrete automáticas nos seguintes momentos:
- Logo após o agendamento (confirmação)
- 1 dia antes da sessão
- 10 horas antes da sessão
- 1 hora antes da sessão

O bot só entra em ação quando o lead RESPONDE a qualquer uma dessas mensagens.
...
Objetivo: Quando o lead responder a qualquer mensagem de lembrete, identificar rapidamente o que ele quer.
...
SE o lead responder positivamente a qualquer lembrete --> ENTÃO reforçar presença (ETAPA 2)
